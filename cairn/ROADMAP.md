...
|---|---|---|---|---|---|
| M11 | A wholly-skipped test file cannot exist — the coverage gate's blind spot, closed at the door | in-progress | M10 | normal | milestones/M11-forbid-top-level-skips.md |
